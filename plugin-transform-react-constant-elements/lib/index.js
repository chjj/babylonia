    ...
    visitor: {
      JSXElement(path) {
        ...
        for (let currentScope = jsxScope;;) {
          ...
          if (!currentScope) {
            throw new Error("Internal babylonia/plugin-transform-react-constant-elements error: " + "targetScope must be an ancestor of jsxScope. " + "This is a Babel bug, please report it.");
          }
        }
