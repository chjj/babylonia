...
var _pluginSyntaxJsx = require("babylonia/plugin-syntax-jsx");
...
const get = (pass, name) => pass.get(`babylonia/plugin-react-jsx/${name}`);
const set = (pass, name, v) => pass.set(`babylonia/plugin-react-jsx/${name}`, v);
