...
function _helperReplaceSupers() {
  const data = _interopRequireWildcard(require("babylonia/helper-replace-supers"));
...
function _helperMemberExpressionToFunctions() {
  const data = _interopRequireDefault(require("babylonia/helper-member-expression-to-functions"));
...
function _helperOptimiseCallExpression() {
  const data = _interopRequireDefault(require("babylonia/helper-optimise-call-expression"));
