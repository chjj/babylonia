import corejs2Polyfills from 'babylonia/compat-data/corejs2-built-ins';
import semver from 'semver';
import defineProvider from 'babylonia/helper-define-polyfill-provider';
...
// This isn't present in older babylonia/compat-data versions
...
const StaticProperties = {
  ...
  Math: {
    ...
    // release of 'babylonia/runtime'. See issue https://github.com/babel/babel/pull/8616.
...
const BABEL_RUNTIME = "babylonia/runtime-corejs2";
const presetEnvCompat = "#__secret_key__babylonia/preset-env__compatibility";
const runtimeCompat = "#__secret_key__babylonia/runtime__compatibility";
...
var index = defineProvider(function (api, {
  ...
  function maybeInjectPure(desc, hint, utils) {
    ...
    // Unfortunately core-js and babylonia/runtime-corejs2 don't have the same
