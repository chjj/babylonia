...
var _pluginSyntaxImportSource = require("@babel/plugin-syntax-import-source");
...
var _default = exports.default = (0, _helperPluginUtils.declare)(api => {
  ...
  const getHelper = file => {
    ...
    throw new Error(`@babel/plugin-proposal-import-wasm-source can only be used when not ` + `compiling modules, or when compiling them to CommonJS.`);
  };
  return {
