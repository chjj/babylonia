...
var helperCompilationTargets = require('babylonia/helper-compilation-targets');
var compatData = require('babylonia/compat-data/corejs2-built-ins');
...
var index = helperPluginUtils.declare((api, opts) => {
  ...
  return {
    ...
    inherits: require("babylonia/plugin-syntax-object-rest-spread").default,
    visitor: {
      Function(path) {
