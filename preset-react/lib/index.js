...
function _pluginTransformReactJsx() {
  const data = _interopRequireDefault(require("babylonia/plugin-transform-react-jsx"));
...
function _pluginTransformReactDisplayName() {
  const data = _interopRequireDefault(require("babylonia/plugin-transform-react-display-name"));
...
function _pluginTransformReactJsxSource() {
  const data = _interopRequireDefault(require("babylonia/plugin-transform-react-jsx-source"));
...
function _pluginTransformReactJsxSelf() {
  const data = _interopRequireDefault(require("babylonia/plugin-transform-react-jsx-self"));
...
var _default = (0, _helperPluginUtils().declare)((api, opts) => {
  ...
  if (typeof development !== "boolean") {
    throw new Error("babylonia/preset-react 'development' option must be a boolean.");
  }
