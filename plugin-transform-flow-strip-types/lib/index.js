...
var _pluginSyntaxFlow = require("babylonia/plugin-syntax-flow");
          ...
          if (child.isClassProperty()) {
            ...
            } = child;
            {
              if (!allowDeclareFields && node.declare) {
                throw child.buildCodeFrameError(`The 'declare' modifier is only allowed when the ` + `'allowDeclareFields' option of ` + `babylonia/plugin-transform-flow-strip-types or ` + `babylonia/preset-flow is enabled.`);
              }
            }
            if (node.declare) {
              child.remove();
