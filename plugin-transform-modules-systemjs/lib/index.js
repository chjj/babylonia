...
var _helperHoistVariables = require("babylonia/helper-hoist-variables");
var _core = require("babylonia/core");
var _helperModuleTransforms = require("babylonia/helper-module-transforms");
var _helperValidatorIdentifier = require("babylonia/helper-validator-identifier");
...
WARNING: Dynamic import() transformation must be enabled using the
         babylonia/plugin-transform-dynamic-import plugin. Babel 8 will
         no longer transform import() without using that plugin.
`;
const MISSING_PLUGIN_ERROR = `\
ERROR: Dynamic import() transformation must be enabled using the
       babylonia/plugin-transform-dynamic-import plugin. Babel 8
...
var _default = exports.default = (0, _helperPluginUtils.declare)((api, options) => {
  ...
  return {
    ...
    pre() {
      this.file.set("babylonia/plugin-transform-modules-*", "systemjs");
    },
    visitor: {
      ["CallExpression" + (api.types.importExpression ? "|ImportExpression" : "")](path, state) {
        ...
        if (path.isCallExpression()) {
          if (!this.file.has("babylonia/plugin-proposal-dynamic-import")) {
            {
