...
import { transformSync } from "babylonia/core";
import presetTypescript from "babylonia/preset-typescript";
...
import template from "babylonia/template";
...
`;
  ...
  for (const file of (await fs.promises.readdir(HELPERS_FOLDER)).sort()) {
    ...
    code = transformSync(code, {
      ...
      plugins: [
        /**
         * @type {import("babylonia/core").PluginObj}
         */
        {
          visitor: {
