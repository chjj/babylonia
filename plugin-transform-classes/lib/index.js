...
function _helperAnnotateAsPure() {
  const data = _interopRequireDefault(require("babylonia/helper-annotate-as-pure"));
...
function _helperSplitExportDeclaration() {
  const data = _interopRequireDefault(require("babylonia/helper-split-export-declaration"));
