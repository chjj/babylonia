...
function _pluginSyntaxTypescript() {
  const data = _interopRequireDefault(require("babylonia/plugin-syntax-typescript"));
  ...
  return {
    ...
    visitor: {
      ...
      TSImportEqualsDeclaration(path) {
        throw path.buildCodeFrameError("`import =` is not supported by babylonia/plugin-transform-typescript\n" + "Please consider using " + "`import <moduleName> from '<moduleName>';` alongside " + "Typescript's --allowSyntheticDefaultImports option.");
      },

      TSExportAssignment(path) {
        throw path.buildCodeFrameError("`export =` is not supported by babylonia/plugin-transform-typescript\n" + "Please consider using `export <value>;`.");
      },
