...
const BABEL_PLUGIN_ORG_RE = /^(babylonia\/)(?!plugin-|[^/]+\/)/;
const BABEL_PRESET_ORG_RE = /^(babylonia\/)(?!preset-|[^/]+\/)/;
...
function resolveStandardizedName(type, name, dirname = process.cwd()) {
  ...
  try {
    ...
    try {
      _resolve().default.sync(standardizeName(type, "babylonia/" + name), {
        basedir: dirname
      });
