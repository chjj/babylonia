...
/**
 * babylonia/preset-modules produces clean, minimal output for ES Modules-supporting browsers.
...
var _default = (0, _helperPluginUtils.declare)((api, opts) => {
  ...
  return {
    ...
    require.resolve("babylonia/plugin-proposal-unicode-property-regex"), require.resolve("babylonia/plugin-transform-dotall-regex")].filter(Boolean)
  };
});
