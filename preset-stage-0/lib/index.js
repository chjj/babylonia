...

{
  "plugins": [
    // Stage 0
    "babylonia/plugin-proposal-function-bind",

    // Stage 1
    "babylonia/plugin-proposal-export-default-from",
    "babylonia/plugin-proposal-logical-assignment-operators",
    ["babylonia/plugin-proposal-optional-chaining", { "loose": false }],
    ["babylonia/plugin-proposal-pipeline-operator", { "proposal": "minimal" }],
    ["babylonia/plugin-proposal-nullish-coalescing-operator", { "loose": false }],
    "babylonia/plugin-proposal-do-expressions",
