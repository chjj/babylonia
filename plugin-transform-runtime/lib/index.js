...
function _helperModuleImports() {
  const data = require("babylonia/helper-module-imports");
...
var _default = (0, _helperPluginUtils().declare)((api, options, dirname) => {
  ...
  const moduleName = injectCoreJS3 ? "babylonia/runtime-corejs3" : injectCoreJS2 ? "babylonia/runtime-corejs2" : "babylonia/runtime";
