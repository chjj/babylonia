...
var _default = (0, _helperPluginUtils().declare)((api, options, dirname) => {
  ...
  if (has(options, "useBuiltIns")) {
    if (options.useBuiltIns) {
      ...
      throw new Error("The 'useBuiltIns' option has been removed. Use the 'corejs'" + "option with value '2' to polyfill with CoreJS 2.x via babylonia/runtime.");
    }
  }
  ...
  if (has(options, "polyfill")) {
    if (options.polyfill === false) {
      ...
      throw new Error("The 'polyfill' option has been removed. Use the 'corejs'" + "option with value '2' to polyfill with CoreJS 2.x via babylonia/runtime.");
    }
  }
  ...
  const moduleName = injectCoreJS2 ? "babylonia/runtime-corejs2" : "babylonia/runtime";
