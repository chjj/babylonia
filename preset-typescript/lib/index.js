...
var transformTypeScript = require('babylonia/plugin-transform-typescript');
require('babylonia/plugin-syntax-jsx');
var transformModulesCommonJS = require('babylonia/plugin-transform-modules-commonjs');
...
const v = new helperValidatorOption.OptionValidator("babylonia/preset-typescript");
