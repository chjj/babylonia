...
function _helperRemapAsyncToGenerator() {
  const data = _interopRequireDefault(require("babylonia/helper-remap-async-to-generator"));
...
function _pluginSyntaxAsyncGenerators() {
  const data = _interopRequireDefault(require("babylonia/plugin-syntax-async-generators"));
