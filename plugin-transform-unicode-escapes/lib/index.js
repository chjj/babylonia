    ...
    visitor: {
      ...
      TemplateElement(path) {
        ...
        if (grandParent.isTaggedTemplateExpression()) {
          throw path.buildCodeFrameError(`Can't replace Unicode escape '${firstEscape}' inside tagged template literals. You can enable 'babylonia/plugin-transform-template-literals' to compile them to classic strings.`);
        }
