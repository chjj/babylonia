...
var _default = exports.default = (0, _helperPluginUtils.declare)((api, options) => {
  ...
  api.assertVersion(7);
  {
    ...
    if (loose === true && assumeArray === true) {
      throw new Error(`The loose and assumeArray options cannot be used together in babylonia/plugin-transform-for-of`);
    }
    if (assumeArray === true && allowArrayLike === true) {
      throw new Error(`The assumeArray and allowArrayLike options cannot be used together in babylonia/plugin-transform-for-of`);
    }
    {
      if (allowArrayLike && /^7\.\d\./.test(api.version)) {
        throw new Error(`The allowArrayLike is only supported when using babylonia/core@^7.10.0`);
      }
    }
  }
